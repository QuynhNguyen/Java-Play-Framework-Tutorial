...
public class BasicTest extends UnitTest {
	...
	public void createPost(){
		//Create new User and save it
		User quynh = new User("Quynh@gmail.com", "secret", "quynh").save();
		
		//create new post
		new Post(quynh, "My first post", "hello world").save();
		
		//Test that the post has been created
		assertEquals(1, Post.count());
		
		List<Post> bobPost = Post.find("byAuthor", quynh).fetch();
		
		//Test
		assertEquals(1, bobPost.size());
		Post firstPost = bobPost.get(0);
		assertNotNull(firstPost);
		assertEquals(quynh, firstPost.author);
